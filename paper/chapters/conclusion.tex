...
system can provide a scalable, global namespace.

First, we presented an API and framework for a programmable metadata load
...
Second, we presented an API and framework for programmable consistency and
