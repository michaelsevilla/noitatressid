...
and increases complexity. The time is ripe, especially with the advent of
workloads with big data, extremely heterogeneous computing environments, and
open-source software, for a programmable storage system approach. We present
programmable file system interfaces implemented on CephFS, that facilitate
application-specific knowledge by allowing administrators to compose building
blocks.
