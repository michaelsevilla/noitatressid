...
The fundamental insight of this thesis is that the default policies of the metadata management
techniques in today's file systems are causing scalability problems for
specialized use cases. Our solution dynamically assigns customized solutions
to various parts of the file system namespace and we present domain-specific
policies that shape metadata management techniques.  To facilitate the
systematic exploration of this design space, we build a programmable file
system with APIs that let developers of higher layers express domain-specific
knowledge in a storage-agnostic way.  Policy engines embedded in the file
system use this knowledge to guide internal
...
metadata generation. These new customizations improve the scalability of file system
metadata management using domain-specific knowledge and are influenced by, and
