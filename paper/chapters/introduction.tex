...
for scaling global namespaces and designing effective file system metadata
management policies. We design policies for three metadata management
...
a novel idea. Because we use the programmable storage approach, each system (1)
is built by composing internal abstractions, (2) uses and re-uses existing
functionality in the underlying file system, and (3) ends up with less layers
than `clean-slate' approaches.
