\section{Background: POSIX IO Overheads}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=1\textwidth]{./chapters/cudele/figures/slowdown-journal.png}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=1\textwidth]{./chapters/cudele/figures/slowdown-interfere-scale.png}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=1\textwidth]{./chapters/cudele/figures/behavior-interfere.png}
