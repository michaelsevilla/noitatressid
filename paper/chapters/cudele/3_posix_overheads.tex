...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.5\linewidth]{./chapters/cudele/figures/slowdown-journal.png}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.5\linewidth]{./chapters/cudele/figures/slowdown-interfere-scale.png}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.5\linewidth]{./chapters/cudele/figures/behavior-interfere.png}
