...
\begin{figure}[tb]
\centering
\includegraphics[width=1\textwidth]{./chapters/cudele/figures/composable-mechanisms.png}
\caption{
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=1\textwidth]{./chapters/cudele/figures/mergescale.png}
  \caption{
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=1\textwidth]{./chapters/cudele/figures/block-allow.png}
  \caption{
...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{./chapters/cudele/figures/slowdown-sync.png}
  \caption{
