...
reproducible, this section adheres to The Popper
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.7\textwidth]{./chapters/cudele/figures/composable-mechanisms.png}
\caption{
...
{\it Overhead of \oldcomment{RPCs}\newcomment{Consistency}:} RPCs are
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.7\textwidth]{./chapters/cudele/figures/mergescale.png}
  \caption{
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.7\textwidth]{./chapters/cudele/figures/block-allow.png}
  \caption{
...
\begin{figure}
  \centering
  \includegraphics[width=0.7\textwidth]{./chapters/cudele/figures/slowdown-sync.png}
  \caption{
...
\newcomment{\textbf{Cudele setup}: we accommodate these workloads in the global
...
\newcomment{\textbf{Cudele setup}: we enable global durability with Stream and
