...
We use a programmable storage approach~\cite{sevilla:eurosys17-malacology} to design
...
system~\cite{sevilla:eurosys17-malacology} and it tells clients how to access the
...
additional security and access control details but they are not described here.
