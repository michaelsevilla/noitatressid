...
\begin{figure}[t]
  \noindent\includegraphics[width=0.5\textwidth]{./chapters/controlplane/parsplice/figures/methodology-keyspace.png}\\
...
\begin{figure}[t]
  \noindent\includegraphics[width=0.5\textwidth]{./chapters/controlplane/parsplice/figures/motivation-regimes.png}\\
...
\begin{figure}[t]
  \noindent\includegraphics[width=0.5\textwidth]{./chapters/controlplane/parsplice/figures/methodology-keys.png}\\
