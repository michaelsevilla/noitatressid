...
DNS, LAN network topologies, and static scoping in programming languages.  Because of
...
and have locality~\cite{roselli:atec2000-FS-workloads,
...
a thorough understanding of many of today's workloads and how they affect metadata
services.  
...
open-source counterpart~\cite{shvachko:msst10}),
...
applications. Relaxing consistency guarantees in this way may not be reasonable
for all applications and could require additional correctness mechanisms.
...
which requires a knowledgeable administrator ({\it i.e.} an administrator familiar with the application, data set, and storage system). Ursa Minor and
